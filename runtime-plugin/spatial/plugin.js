...
'.sp-w{position:absolute;left:0;top:0;transform-origin:0 0;will-change:transform}','.sp-w::after{content:"";position:absolute;left:5%;right:5%;bottom:8%;height:42%;pointer-events:none;background:radial-gradient(60% 55% at 50% 100%,rgba(0,0,0,.045),transparent 70%);z-index:0}',
