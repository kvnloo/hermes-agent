...
- **A conversation timeline rail** — a slim rail of markers along the edge of the transcript, one per prompt. Hover a marker to peek its prompt, and click one to jump straight to that point in the conversation.
